...
logger = logging.getLogger("BearHouseScraper")

# ── Config ───────────────────────────────────────────────────────────────────
SITE_BASE    = "https://thebearhouse.com"
API_BASE     = f"{SITE_BASE}/collections/polo/products.json"
LIMIT        = 250         # Shopify's hard max per page
CONCURRENCY  = 3

OUTPUT_DIR   = os.path.join(os.path.dirname(os.path.abspath(__file__)), "outputs")
OUTPUT_FILE  = os.path.join(OUTPUT_DIR, "bearhouse_polo.json")
